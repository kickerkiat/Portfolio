...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function So(e,t,n){let r=new Float32Array(so),i=new W(0,1,0);return new na({name:`SphericalGaussianBlur`,defines:{n:so,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:To(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Co(){return new na({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:To(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wo(){return new na({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:To(),fragmentShader:`
	...
	`}var Eo=class extends kn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Ui([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),c=new ji(i,s);t.add(c);let l;function u(e){s.uniforms.time.value=e*.001,r.render(t,n),l=requestAnimationFrame(u)}function d(){let e=window.innerWidth,t=window.innerHeight;r.setSize(e,t),s.uniforms.resolution.value.set(e,t)}return u(),d(),window.addEventListener(`resize`,d),()=>{cancelAnimationFrame(l),window.removeEventListener(`mousemove`,o),window.removeEventListener(`resize`,d),i.dispose(),s.dispose(),r.dispose()}}function dl(){return(0,b.jsxs)(`div`,{className:`indicator`,children:[(0,b.jsx)(`div`,{className:`mouse`,children:(0,b.jsx)(`div`,{className:`wheel`})}),(0,b.jsx)(`span`,{children:`Scroll`})]})}function fl(){let e={home:(0,_.useRef)(null),education:(0,_.useRef)(null),project:(0,_.useRef)(null),experience:(0,_.useRef)(null),leadership:(0,_.useRef)(null)},[t,n]=(0,_.useState)(null),[r,i]=(0,_.useState)(!1),a=(0,_.useRef)(null);return(0,_.useEffect)(()=>{if(a.current)return ul(a.current)},[]),(0,_.useEffect)(()=>{let t=new IntersectionObserver(e=>{e.forEach(e=>{if(e.isIntersecting){let t=e.target.dataset.section;if(t==`home`){n(`contact`);return}n(t)}})},{threshold:.5});return Object.entries(e).forEach(([e,n])=>{n.current&&(n.current.dataset.section=e,t.observe(n.current))}),()=>t.disconnect()},[]),(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(`canvas`,{id:`bg`,ref:a}),(0,b.jsx)(x,{HomeClick:()=>e.home.current.scrollIntoView({behavior:`smooth`}),EducationClick:()=>e.education.current.scrollIntoView({behavior:`smooth`}),ProjectClick:()=>e.project.current.scrollIntoView({behavior:`smooth`}),ExperienceClick:()=>e.experience.current.scrollIntoView({behavior:`smooth`}),LeadershipClick:()=>e.leadership.current.scrollIntoView({behavior:`smooth`}),ContactMeClick:()=>{e.home.current.scrollIntoView({behavior:`smooth`}),i(!r)},active:t,setActive:n}),(0,b.jsxs)(`div`,{className:`Container`,children:[(0,b.jsx)(`div`,{ref:e.home,children:(0,b.jsx)(O,{Clicked:r})}),(0,b.jsx)(`div`,{ref:e.education,children:(0,b.jsx)(pe,{})}),(0,b.jsx)(`div`,{ref:e.project,children:(0,b.jsx)(F,{})}),(0,b.jsx)(`div`,{ref:e.experience,children:(0,b.jsx)(ue,{})}),(0,b.jsx)(`div`,{ref:e.leadership,children:(0,b.jsx)(ge,{})})]}),t==`home`&&(0,b.jsx)(dl,{})]})}(0,g.createRoot)(document.getElementById(`root`)).render((0,b.jsx)(_.StrictMode,{children:(0,b.jsx)(fl,{})}));