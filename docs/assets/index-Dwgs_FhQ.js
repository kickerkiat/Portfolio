...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yo(e,t,n){let r=new Float32Array(io),i=new W(0,1,0);return new $i({name:`SphericalGaussianBlur`,defines:{n:io,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:So(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bo(){return new $i({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:So(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(){return new $i({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:So(),fragmentShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),c=new Oi(i,s);t.add(c);let l;function u(e){s.uniforms.time.value=e*.001,r.render(t,n),l=requestAnimationFrame(u)}function d(){let e=window.innerWidth,t=window.innerHeight;r.setSize(e,t),s.uniforms.resolution.value.set(e,t)}return u(),d(),window.addEventListener(`resize`,d),()=>{cancelAnimationFrame(l),window.removeEventListener(`mousemove`,o),window.removeEventListener(`resize`,d),i.dispose(),s.dispose(),r.dispose()}}function cl(){let e=(0,_.useRef)(null),t=(0,_.useRef)(null),n=(0,_.useRef)(null),r=(0,_.useRef)(null),i=(0,_.useRef)(null),[a,o]=(0,_.useState)(!1),s=(0,_.useRef)(null);return(0,_.useEffect)(()=>{if(s.current)return sl(s.current)},[]),(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(`canvas`,{id:`bg`,ref:s}),(0,b.jsx)(x,{HomeClick:()=>e.current.scrollIntoView({behavior:`smooth`}),EducationClick:()=>t.current.scrollIntoView({behavior:`smooth`}),ProjectClick:()=>n.current.scrollIntoView({behavior:`smooth`}),ExperienceClick:()=>r.current.scrollIntoView({behavior:`smooth`}),LeadershipClick:()=>i.current.scrollIntoView({behavior:`smooth`}),ContactMeClick:()=>{e.current.scrollIntoView({behavior:`smooth`}),o(!a)}}),(0,b.jsxs)(`div`,{className:`Container`,children:[(0,b.jsx)(`div`,{ref:e,children:(0,b.jsx)(D,{Clicked:a})}),(0,b.jsx)(`div`,{ref:t,children:(0,b.jsx)(ue,{})}),(0,b.jsx)(`div`,{ref:n,children:(0,b.jsx)(P,{})}),(0,b.jsx)(`div`,{ref:r,children:(0,b.jsx)(ce,{})}),(0,b.jsx)(`div`,{ref:i,children:(0,b.jsx)(pe,{})})]})]})}(0,g.createRoot)(document.getElementById(`root`)).render((0,b.jsx)(_.StrictMode,{children:(0,b.jsx)(cl,{})}));