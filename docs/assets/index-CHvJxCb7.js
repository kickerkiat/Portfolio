...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(e,t,n){let r=new Float32Array(oo),i=new W(0,1,0);return new ta({name:`SphericalGaussianBlur`,defines:{n:oo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:wo(),fragmentShader:`
	...
	`}var To=class extends On{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Hi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),c=new Ai(i,s);t.add(c);let l;function u(e){s.uniforms.time.value=e*.001,r.render(t,n),l=requestAnimationFrame(u)}function d(){let e=window.innerWidth,t=window.innerHeight;r.setSize(e,t),s.uniforms.resolution.value.set(e,t)}return u(),d(),window.addEventListener(`resize`,d),()=>{cancelAnimationFrame(l),window.removeEventListener(`mousemove`,o),window.removeEventListener(`resize`,d),i.dispose(),s.dispose(),r.dispose()}}function ul(){let e=(0,_.useRef)(null),t=(0,_.useRef)(null),n=(0,_.useRef)(null),r=(0,_.useRef)(null),i=(0,_.useRef)(null),[a,o]=(0,_.useState)(!1),s=(0,_.useRef)(null);return(0,_.useEffect)(()=>{if(s.current)return ll(s.current)},[]),(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(`canvas`,{id:`bg`,ref:s}),(0,b.jsx)(x,{HomeClick:()=>e.current.scrollIntoView({behavior:`smooth`}),EducationClick:()=>t.current.scrollIntoView({behavior:`smooth`}),ProjectClick:()=>n.current.scrollIntoView({behavior:`smooth`}),ExperienceClick:()=>r.current.scrollIntoView({behavior:`smooth`}),LeadershipClick:()=>i.current.scrollIntoView({behavior:`smooth`}),ContactMeClick:()=>{e.current.scrollIntoView({behavior:`smooth`}),o(!a)}}),(0,b.jsxs)(`div`,{className:`Container`,children:[(0,b.jsx)(`div`,{ref:e,children:(0,b.jsx)(D,{Clicked:a})}),(0,b.jsx)(`div`,{ref:t,children:(0,b.jsx)(fe,{})}),(0,b.jsx)(`div`,{ref:n,children:(0,b.jsx)(N,{})}),(0,b.jsx)(`div`,{ref:r,children:(0,b.jsx)(le,{})}),(0,b.jsx)(`div`,{ref:i,children:(0,b.jsx)(he,{})})]})]})}(0,g.createRoot)(document.getElementById(`root`)).render((0,b.jsx)(_.StrictMode,{children:(0,b.jsx)(ul,{})}));